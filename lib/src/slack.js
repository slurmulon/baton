...
export const msg = (req: Object, text: String, icon_emoji: String = ':tanabata_tree') => {
  return node.respond(req.body, () => `:${icon_emoji}: ${text}`)
}

export const err = (req: Object, text: String) => {
  return node.respond(req.body, () => `:boom: ${text}`)
}
